...
import { User, Mail, Lock, ArrowRight, Image } from 'lucide-react';
...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-[85vh] flex flex-col bg-slate-50 py-8">
            <div className="grow flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-2xl space-y-6 relative overflow-hidden">
                        ...
                        <Form className="space-y-4" onSubmit={onSubmit} autoComplete="off">
                            ...
                            <div className="space-y-1 w-full">
                                ...
                                <TextField isRequired name="photoUrl" type="text" className="w-full">
                                    <div className="relative flex items-center w-full">
                                        <Image className="absolute left-3 w-4 h-4 text-slate-400 z-10" />
                                        <Input
